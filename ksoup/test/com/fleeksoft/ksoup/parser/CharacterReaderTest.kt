...
class CharacterReaderTest {
    ...
    fun testUtf16BE() = runTest {
        ...
        val input = TestHelper.readFile(TestHelper.getResourceAbsolutePath("bomtests/bom_utf16be.html"))
...
//            ignore first char (ZWNBSP)\uFEFF:65279
    ...
    fun testUtf16LE() = runTest {
        val firstLine = """<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">"""
        val input = TestHelper.readFile(TestHelper.getResourceAbsolutePath("bomtests/bom_utf16le.html"))
    ...
    fun linenumbersAgreeWithEditor() = runTest {
        val content: String = TestHelper.readFile(TestHelper.getResourceAbsolutePath("htmltests/large.html.gz"))
        val reader = CharacterReader(content)
        reader.trackNewlines(true)
