...
class PerformanceComparisonTest {
    ...
    fun compareWithJsoup() = runTest {
        ...
        val testData2 =
            GZIPInputStream(FileInputStream(TestHelper.getResourceAbsolutePath("htmltests/news-big-page.html.gz"))).readAllBytes().decodeToString()
    ...
    private fun printComparisonTable(
        ...
        // Print table header
        println("\nComparison Table Ksoup Kotlinx vs Jsoup")
        println(
